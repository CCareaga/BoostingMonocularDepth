...
CURR_PATH = torch.hub.get_dir()

# OUR
from boosted_depth.utils import calculateprocessingres

# MIDAS
from boosted_depth.midas.models.midas_net import MidasNet
from boosted_depth.midas.models.transforms import Resize, NormalizeImage, PrepareForNet

# PIX2PIX : MERGE NET
from boosted_depth.pix2pix.models.pix2pix4depth_model import Pix2Pix4DepthModel
...
def create_depth_models(device='cuda', midas_path=None, pix2pix_path=None):
    ...
    if pix2pix_path is None:
        ...
        pix2pixmodel.save_dir = f'{CURR_PATH}/mergemodel'
    else:
    ...
    if midas_path is None:
        midas_model_path = f"{CURR_PATH}/midas/model.pt"
    else:
